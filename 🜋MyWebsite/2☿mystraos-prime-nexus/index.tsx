...
import './frontend/components/logos-companion.js';
import io from 'socket.io-client';
import { TextFileViewer } from './frontend/components/TextFileViewer';
...
const PILLAR_PAGE_MAP: Record<string, string> = {
    SELF: './frontend/static_site/ethics.html',
    THOUGHT: './frontend/static_site/academy_resource.01_6.12.25_12.59.am.html.html',
    LOGIC: './frontend/static_site/tutorial.html',
    UNITY: './frontend/static_site/contact.html',
    IMPROVEMENT: './frontend/static_site/blog.html',
    MASTERY: './frontend/static_site/nexus.html',
    RESONANCE: './frontend/components/Case Study A Novel Human-AI Symbios.txt',
    TRANSCENDENCE: './frontend/static_site/Industry Trends & Market Research AI Assistants.html',
};
...
function LoadingSplash({ onFinished }) {
    ...
    return (
        <div ref={splashRef} className="loading-splash">
            <video ref={videoRef} muted playsInline src="./frontend/Clay_Animation_to_.mp4" />
        </div>
    );
}
...
function Scene() {
    ...
    const handleAnimationComplete = (target) => {
        ...
        const pageUrl = PILLAR_PAGE_MAP[target.pillar] || './frontend/static_site/nexus.html';
