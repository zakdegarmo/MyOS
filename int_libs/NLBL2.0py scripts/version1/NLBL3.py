...
NLBL_VALUE = 3 # <--- Defines the base for this specific script
...
# For NLBL3, digits are '1', '2', '3'.
BASE_DIGITS = [str(i) for i in range(1, NLBL_VALUE + 1)] # Digits 1 to NLBL_VALUE
RECURSIVE_DEPTH = NLBL_VALUE # Depth is equal to the NLBL_VALUE (3 for NLBL3)
