// MyServer.js - v14 (Super-Robust Desktop Agent Import & CORS Enabled)

import express from 'express';
import { exec } from 'child_process';
import path from 'path';
import { fileURLToPath, pathToFileURL } from 'url'; // <--- MODIFIED: Import pathToFileURL
...
const DESKTOP_AGENT_MODULE_URL = pathToFileURL(DESKTOP_AGENT_FILE_PATH).href; // <--- NEW: Convert to URL
...
app.listen(port, async () => {
    ...
    try {
        ...
        DesktopAgent = DesktopAgentModule.default; // Assign the default export
        ...
        // If DesktopAgent import fails, it will be caught here.
